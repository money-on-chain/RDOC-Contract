...
module.exports = async callback => {
  try {
    ...
    if (changerInfo.mocAtomicImplementation === config.implementationAddresses.MoC_v0116_2) {
      console.log(
        'OK. Implementation MoC_v0116_2.sol contract: ',
        changerInfo.mocAtomicImplementation
      );
    } else {
      console.log(
        'ERROR! Implementation MoC_v0116_2.sol is not the same ',
    ...
    if (
      ...
      console.log(
        'OK. Implementation MoCConnector_v0116_2.sol contract: ',
        changerInfo.mocConnectorAtomicImplementation
      );
    } else {
      console.log(
        'ERROR! Implementation MoCConnector_v0116_2.sol is not the same ',
        changerInfo.mocConnectorAtomicImplementation
      );
    }
    ...
    if (
      ...
      console.log(
        'OK. Implementation MoCExchange_v0116_2.sol contract: ',
        changerInfo.mocExchangeAtomicImplementation
      );
    } else {
      console.log(
        'ERROR! Implementation MoCExchange_v0116_2.sol is not the same ',
        changerInfo.mocExchangeAtomicImplementation
      );
    }
    ...
    if (
      changerInfo.mocStateAtomicImplementation === config.implementationAddresses.MoCState_v0116_2
    ) {
      console.log(
        'OK. Implementation MoCState_v0116_2.sol contract: ',
        changerInfo.mocStateAtomicImplementation
      );
    } else {
      console.log(
        'ERROR! Implementation MoCState_v0116_2.sol is not the same ',
        changerInfo.mocStateAtomicImplementation
      );
    }
    ...
    if (
      ...
      console.log(
        'OK. Implementation MoCSettlement_v0116_2.sol contract: ',
        changerInfo.mocSettlementAtomicImplementation
      );
    } else {
      console.log(
        'ERROR! Implementation MoCSettlement_v0116_2.sol is not the same ',
        changerInfo.mocSettlementAtomicImplementation
      );
    }
