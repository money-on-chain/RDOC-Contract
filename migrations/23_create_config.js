...
module.exports = async (deployer, currentNetwork, [owner]) => {
  ...
  let filePath = `../scripts/deploy/deployments/deployConfig-${currentNetwork}.json`;
  let filePathCopy = `../scripts/deploy/deployments/deployConfig-${currentNetwork}-original.json`;
