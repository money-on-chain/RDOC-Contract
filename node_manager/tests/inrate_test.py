...
interest_v = moc_inrate.functions.calcMintInterestValues(str.encode('X2'), 10000000000000000).call()
print("Interest: {0}".format(interest_v))

interest_v = moc_inrate.functions.riskProxInrateAvg(str.encode('X2'), 1 * 10 ** 18, False).call()
print("Interest: {0}".format(Web3.fromWei(interest_v, 'ether')))

result = moc_inrate.functions.stableTokenInrateAvg(1).call()
