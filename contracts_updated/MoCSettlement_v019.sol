...
contract MoCSettlementEvents_v019 {
...
contract MoCSettlement_v019 is MoCSettlementEvents_v019, MoCBase, PartialExecution, Governed {
  ...
  **/
    ...
    function initialize(address connectorAddress, address _governor, uint256 _blockSpan)
        public
        initializer
    {
  ...
  */
    ...
    /**
    @dev } final step of Settlement task group
  */
    ...
    function stableTokenRedemptionStep(uint256 index) internal {
        ...
        if (amountToRedeem > 0) {
            (bool result, uint256 reserveTokenCommissionSpent) = mocExchange
                .redeemStableTokenWithPrice(redeemer, amountToRedeem, settlementInfo.reservePrice);
            ...
            if (result) {
                ...
                settlementInfo.partialCommissionAmount = settlementInfo.partialCommissionAmount.add(
