...
import "../contracts/interfaces/IMoCState.sol";
import "../contracts/interfaces/IMoCSettlement.sol";
import "../contracts/interfaces/IMoCExchange.sol";
...
import "../contracts/interfaces/IMoCVendors.sol";
import "../contracts/interfaces/IMoCInrate.sol";
import "../contracts/interfaces/IMoC.sol";

contract MoCEvents_v0116_1 {
  event BucketLiquidation(bytes32 bucket);
  event ContractLiquidated(address mocAddress);
}

contract MoC_v0116_1 is MoCEvents_v0116_1, MoCReserve, MoCLibConnection, MoCBase, Stoppable, IMoC {
