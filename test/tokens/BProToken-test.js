...
const RiskProToken = artifacts.require('./contracts/RiskProToken.sol');

contract('RiskProToken', function([owner, anotherAccount, ...otherAccounts]) {
  const minter = owner;
  let token;
  ...
  beforeEach(async function() {
    token = await RiskProToken.new({ from: owner });
